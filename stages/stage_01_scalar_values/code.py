...
class Value:
    ...
    def __add__(self, other):
        ...
        return self._make(self.data + other.data, _children=(self, other), _op= '+')
    ...
    def __pow__(self, exponent):
        ...
        assert isinstance(exponent,(int, float)), 'exponent must be an integer or float.'

        return self._make(self.data ** exponent, _children= (self,), _op= f'**{exponent}')
